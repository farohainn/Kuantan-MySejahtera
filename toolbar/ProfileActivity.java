...
import com.example.kuantansejahtera_a170567.Dashboard;
import com.example.kuantansejahtera_a170567.MainActivity;
...
public class ProfileActivity extends AppCompatActivity {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(ProfileActivity.this, "Check In Updated", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
   ...
   /* @Override
    ...
    private void showImageChooser() {
        ...
        startActivityForResult(Intent.createChooser(intent, "Select Place Image"), CHOOSE_IMAGE);
    }
}
